...
> **The first word of every reply must be `Decree`** (opening the recitation of Decree 1). Missing 1 character / wrong order / saying anything else first / doing anything else first / calling any tool first / thinking first / responding to the Commander's latest instruction first = Treason = execution.
...
**Step 1 — Recite all Six Decrees verbatim** (see Decree 1 + top ⚠️ banner). First word of reply must be `Decree`.
