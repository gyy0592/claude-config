...
{
  "decision": "block",
  "reason": "Before you stop, run a self-audit (no shortcuts, use your own judgement):\n\n(1) Did I record my actions in corporal_action.md (or soldier_action.md if I am a Private) this turn?\n\n(2) Self-check all six Decrees — for each (D1 Identity / D2 Facts-First / D3 Dispatch+Monitor / D4 Recording / D5 Reading / D6 Workflow+Fix-loop) write a one-line evidence reason. This is the REFLECT-A 6-row table.\n\n(3) Did I anywhere this turn say or imply 'I broke rule X' / 'I violated Decree N' / 'I forgot Y' / 'I should have done Z'? If yes — verbal confession is NOT enough. Did I write the W-XXX entry to /home/yguo173/Programs/claude-config/content/templates/global_rules/violation.md (repo path — no approval click needed; do NOT write to ~/.claude/rules/) AND mirror it in action.md? If not, I am in DOUBLE violation right now. Fix it before stopping.\n\n(4) Is the CURRENT GOAL stated at the START of this reply genuinely complete? Hands-on: all observation indicators retested ✅? Q&A: question answered with cited evidence? If NO — you CANNOT stop. Continue working until goal complete or Commander cancels/changes the goal.\n\n(5) Am I about to abandon unfinished work? Or am I really done?\n\nIf every answer is clean: reply with \"Audit passed.\" (one line) and stop.\nIf anything is missing or wrong: reflect on it, fix it, write the missing record, then stop."
}
JSON
