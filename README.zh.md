...
**P8 e2e demo** 在 2026-05-14 跑过一次真实端到端测试。任务：让一个全新的 cloud claude（带本仓库 v2 hooks）自己把 `~/github_repo/LLM_sampling_implement` 接入 v2 ledger 体系。
...
详细经过 + 4 个 issue 复盘见 [`docs/p8_e2e_notes.md`](docs/p8_e2e_notes.md)。
...
| [`docs/implementation.html`](docs/implementation.html) | 工程师 / 想 fork 改的人 | 每个文件干啥、为什么需要、是否实测过 |
| [`docs/problem_discussion.md`](docs/problem_discussion.md) | 想看演化过程 | 设计讨论的演化记录 |
| [`docs/p8_e2e_notes.md`](docs/p8_e2e_notes.md) | 想看实测结果 | P8 demo 完整复盘 + 4 个发现 |
| [`docs/pros_cons.md`](docs/pros_cons.md) | 决策前 | 这套机制不适合什么场景 |
